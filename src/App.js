...
function App() {
  ...
  return (
    <div className="h-screen flex flex-col bg-white dark:bg-dark-content">
      ...
      <div className="pt-8 flex-1 flex flex-col h-[calc(100vh-32px)]">
        ...
        <div className="flex-1 overflow-hidden">
          ...
          >
            {/* Settings Panel */}
            <div className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 overflow-y-auto">
    ...
    transition-colors duration-150 flex items-center gap-1"
                  ...
                  border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="text-xs text-gray-600">
                        ...
                        <pre className="mt-1 overflow-auto max-h-32 bg-white p-2 rounded border border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300">
    ...
    ${isLoading || !projectRef || !artistRef || !basePath
                        ...
                        : 'bg-blue-600 dark:bg-emerald-600 hover:bg-blue-700 dark:hover:bg-emerald-700'
                      }`}
                  >
                    ...
                    <>
                      <div className="relative py-2">
                        ...
                        <div className="relative flex justify-center text-sm">
                          <span className="px-2 py-2 bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400">
                            Quick Actions
                          </span>
                        </div>
                      </div>
            ...
            {/* Directory View */}
            <div className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 overflow-y-auto">
